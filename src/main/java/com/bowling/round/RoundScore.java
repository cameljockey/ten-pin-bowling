...
/**
 * <p>
 * Provides the Score calculation feature to {@link com.bowling.round.Round}.
...
public interface RoundScore {
	 ...
	 * {@link com.bowling.round.Round}. We need next Two
	 * {@link com.bowling.roll.Roll}s too in here so that we should calculate Score
	 ...
	 * @param thirdRoll
	 *            has the Roll representation of third {@link com.bowling.roll.Roll}
	 * @return Integer as Score calculated for {@link com.bowling.round.Round}
	 * @since 1.0
	 */
